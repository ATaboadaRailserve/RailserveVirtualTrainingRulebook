...
public class Uber_Groundman_Duties : MonoBehaviour
{

	public UberSubmodule loadingRacksSubmodule;
    ...
    //public UberModule loadingRacksModule;

    public Animator animTheMove;

    public UberSubmodule chockCheckIn;
    ...
    public void DetectConfirmation()
    {
        ...
        if (lookedAt == false)
        {
			loadingRacksSubmodule.PushServerMessage("Loading Rack: That object isn't out of place.");
			loadingRacksSubmodule.FailSubmodule();
            //iHandler.CustomGameState("Loading Rack: That object isn't out of place.");
            //loadingRacksModule.FailModule();
        }
    ...
    public void ChockCheck()
    {
        if (chockCount < chockCountMin)
        {
            loadingRacksSubmodule.PushServerMessage("Chocking: Mis-chocked car");
			loadingRacksSubmodule.FailSubmodule();
        }
        else
        {
            chockCheckIn.CompleteSubmodule();
        }
    }
    ...
    public void CheckAllClear()
    {
        if (allGood)
        {
            ...
            //    ResetScene();
            //}
            loadingRacksSubmodule.CompleteSubmodule();
        }
        else
        {
            loadingRacksSubmodule.PushServerMessage("Loading Rack: Not everything is cleared.");
			loadingRacksSubmodule.FailSubmodule();
            //loadingRacksModule.FailModule();
        }
    }

    public void PushTheMove ()
    {
       // animTheMove.Play()
    }

    public void HaltTheMove ()
    {
